  ...
  return (
    <div className="flex justify-center items-center h-screen p-6">
      <div className="flex flex-col gap-4 md:gap-16 xl:gap-24">
        <img className="w-5/12 xl:w-3/12 mx-auto" src={check} alt="" />
        <div className="flex flex-col">
          <p className="h4 font-medium text-center xl:text-left">
            Checkout Berhasil, Kamu dapat menghubungi mentor yang sudah kamu
            pilih
          </p>
          <div className="flex justify-center items-center gap-5 xl:mt-8 py-6 flex-col">
            ...
            <div className="flex gap-5 xl:mb-8">
